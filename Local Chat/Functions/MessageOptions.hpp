...
const std::vector<std::string> optionsMessage = {"Iniciar conexao com o chat.", "Ser o host do chat.", "Dados do cliente/servidor.", "Sair do programa."};
...
int GetInputToOption()
{
    ...
    do
    {
        ...
        if(responsePlayer == '\n' || responsePlayer == EOF) { anyError = true; ShowOptions(); }
